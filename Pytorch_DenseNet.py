...
if training_losses:
    ...
    plt.legend()
    plt.grid(True)
    save_path_loss = f"./result/densenet121_loss_evolution.png"
...
if training_accuracy:
    ...
    plt.legend()
    plt.grid(True)
    save_path_accuracy = f"./result/densenet121_accuracy_evolution.png"
...
plt.ylabel('True')
save_path_confusion_matrix = f"./result/densenet121_confusion_matrix.png"
...
for i, (img, label) in enumerate(correct_samples[:5]):
    ...
    axes[i].axis("off")
save_path_correctly_classified = f"./result/densenet121_correctly_classified.png"
...
for i, (img, label) in enumerate(incorrect_samples[:5]):
    ...
    axes[i].set_title(f"True: {train_dataset.classes[label]}")
    axes[i].axis("off")
save_path_incorrectly_classified = f"./result/densenet121_incorrectly_classified.png"
